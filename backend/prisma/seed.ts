...
async function main() {
  // Single-restaurant seed matching your current in-memory store defaults.
  ...
  // Menu items (prices stored as JSON array to match frontend shape)
  const items = [
    {
      id: 'item1',
      categoryId: 'cat1',
  ...
  // Tables
  const tables = [
    { id: 'T1', label: 'T1', capacity: 4, status: 'seated' as const, serverId: 'staff1', currentOrderId: 'order-123', x: 50, y: 50 },
    { id: 'T2', label: 'T2', capacity: 2, status: 'vacant' as const, x: 350, y: 50 },
    { id: 'T3', label: 'T3', capacity: 6, status: 'served' as const, serverId: 'staff2', currentOrderId: 'order-124', x: 50, y: 300 },
    { id: 'T4', label: 'T4', capacity: 4, status: 'cleaning' as const, x: 350, y: 300 },
  ];
  ...
  // Inventory
  const inventory = [
    { id: 'inv1', name: 'Beef Patties', sku: 'BP-001', onHand: 45, parLevel: 20, unit: 'pcs', unitCost: 1.5, status: 'In_Stock' as const },
    { id: 'inv2', name: 'Brioche Buns', sku: 'BB-001', onHand: 12, parLevel: 25, unit: 'pcs', unitCost: 0.45, status: 'Low_Stock' as const },
    { id: 'inv3', name: 'Tomato Sauce', sku: 'TS-001', onHand: 0, parLevel: 5, unit: 'gallons', unitCost: 12.0, status: 'Out_of_Stock' as const },
    { id: 'inv4', name: 'Romaine Lettuce', sku: 'RL-001', onHand: 20, parLevel: 10, unit: 'lbs', unitCost: 2.2, status: 'In_Stock' as const },
    { id: 'inv5', name: 'Parmesan', sku: 'PM-001', onHand: 15, parLevel: 5, unit: 'lbs', unitCost: 8.5, status: 'In_Stock' as const },
  ];
  ...
  // Ensure Table.currentOrderId FK exists for seeded orders
